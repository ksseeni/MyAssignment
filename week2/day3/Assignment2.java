...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		duplicate.click();
		WebElement company1 = driver.findElement(By.id("createLeadForm_companyName"));
		company1.clear();
		company1.sendKeys("Infosys");
		WebElement firstnm1 = driver.findElement(By.id("createLeadForm_firstName"));
		firstnm1.clear();
		firstnm1.sendKeys("Seeni");
